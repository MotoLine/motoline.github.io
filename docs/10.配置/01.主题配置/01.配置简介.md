...
export default {
  ...
  Layout: defineComponent({
    name: "TeekProvider",
    setup() {
      provide(teekConfigContext, { author: { name: "MotoLine" } });
...
Teek 的所有主题配置请阅读 [Types](https://github.com/MotoLine/vitepress-theme-teek/blob/master/packages/config/types.ts) 文件。

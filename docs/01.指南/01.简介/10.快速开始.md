...
如果你想快速构建一个和 Teek 文档类似的项目，可以直接拉取 [Teek 文档模板仓库](https://github.com/MotoLine/vitepress-theme-teek-docs-template)。

```sh
git clone https://github.com/MotoLine/vitepress-theme-teek-docs-template.git
```
